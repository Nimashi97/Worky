...
public class CountPageTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_count_page_two);
       ...
       /*n1.setOnValueChangedListener(new NumberPicker.OnValueChangeListener()
       {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (m==0 && s == 0) {
                    Toast.makeText(CountPageTwoActivity.this, "Let's move to the next one", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CountPageTwoActivity.this, CounterActivity.class);
                    startActivity(intent);
...
//        v1.setText(t1);
        ...
        DatabaseHelper th = new DatabaseHelper(CountPageTwoActivity.this);
        SQLiteDatabase db = th.getWritableDatabase();
        String sql = "INSERT INTO workout(min,sec,date) VALUES ('" + tm + "','" + tt + "','" + date + "')";
        db.execSQL(sql);
        //Toast.makeText(CountPageTwoActivity.this, "Saved Successfully!" + tm +tt, Toast.LENGTH_SHORT).show();
    }
