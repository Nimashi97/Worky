...
public class CountPageThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_count_page_three);
       ...
       /*n1.setOnValueChangedListener(new NumberPicker.OnValueChangeListener()
       {
        ...
        handler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (m==0 && s == 0) {
                    Toast.makeText(CountPageThreeActivity.this, "Let's move to the next one", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(CountPageThreeActivity.this, ExMainActivity.class);
                    startActivity(intent);
...
//        v1.setText(t1);
        ...
        DatabaseHelper th = new DatabaseHelper(CountPageThreeActivity.this);
        SQLiteDatabase db = th.getWritableDatabase();
        String sql = "INSERT INTO workout(min,sec,date) VALUES ('" + tm + "','" + tt + "','" + date + "')";
        db.execSQL(sql);
        //Toast.makeText(CountPageThreeActivity.this, "", Toast.LENGTH_SHORT).show();
    }
}
